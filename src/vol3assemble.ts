// Assemble the final Volume 3 PDF from the gpt-image-2 pages. Order: cover, how-it-works,
// then each case's question + answer page, then the closing page. Each 1024x1536 PNG is
// recompressed to a baseline JPEG (quality 90, 4:4:4) and embedded full-bleed on a 6x9in
// (2:3) page, matching Volume 1 / Volume 2 / Could You Spot It exactly.
// Output: products/volume-3/volume-3.pdf
...
pdf.setTitle("Weird X-Ray Case Files: Volume 3");
pdf.setAuthor("@mdnoteslab");
pdf.setSubject("A guess-the-diagnosis X-ray puzzle book");
pdf.setCreator("@mdnoteslab — Weird X-Ray Case Files");

const out = join(dir, "volume-3.pdf");
