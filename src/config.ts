...
export const config = {
  ...
  // 18:00 UTC = 9 PM Cairo (UTC+3), matching the reply bot's 21-9 active window. (Reverted from a
  // 4 AM US-prime trial: timing proved secondary to content, and 9 PM keeps the owner awake to engage.)
